...
function split() {
  var clutter = "";
  var charArray = document.querySelector("#page1>h2").textContent.split("");
...
function split1() {
  var clutter = "";
  var charArray = document.querySelector("#page1>h3").textContent.split("");
  
  charArray.forEach(function(char) {
    clutter = clutter + `<span>${char}</span>`;
  });
  
  document.querySelector("#page1>h3").innerHTML = clutter;
}
split1();
...
gsap.to("#page1 #haeder>svg path",{
  scrollTrigger:{
    trigger:"#page1 #haeder>svg path",
    scroller:"#main",
    // markers:true,
    // pin:true,
    scrub:true,
...
function split3() {
  var clutter = "";
  var charArray = document.querySelector("#page2 #center-text #two ").textContent.split("");
  
  charArray.forEach(function(char) {
    clutter = clutter + `<span>${char}</span>`;
  });
  
  document.querySelector("#page2 #center-text #two").innerHTML = clutter;
}
split3();

gsap.from("#page2 #center-text #two>span",{
  scrollTrigger:{
    trigger:"#page2 #center-text #two >span",
    scroller:"#main",
    // markers:true,
    // pin:true,
    scrub:true,
